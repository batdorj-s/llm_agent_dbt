...
vi.mock("yaml", () => ({
    parse: vi.fn().mockReturnValue({
        ...
        tech_agent_sql_gen: "Generate PostgreSQL SQL from the user query. {catalog}",
        ...
        self_query_transform: "Extract search filters from the user's query. {query}",
        data_scientist_python_gen: "Write Python code for data analysis. {tableName} {columns} {dateHint} {numericCols} {categoryCols} {schemaDef} {ragContext} {dataSource} {sampleJson} {statsSummary} {analysisType} {analysisHints} {chartType} {chartReason} {totalRows}",
        data_scientist_explain: "Explain Python analysis results in Mongolian. {analysisType} {query} {pythonCode} {output}",
        tech_agent_python_gen: "Write Python code for this task. {rawQuery}",
        tech_agent_python_explain: "Summarize Python results in Mongolian. {pythonCode} {output}",
        sql_retry_feedback: "SQL failed: {query} {feedback} {schemaContext}",
        empty_result_feedback: "SQL returned empty results.",
        data_profiler_passport: "Generate data passport for {tableName} {description} {columnInfo} {sampleRows} {sampleJson}",
        data_profiler_system: "Return only valid JSON.",
    }),
    default: {
        parse: vi.fn().mockReturnValue({
            supervisor: "Route the following query...",
            supervisor_end: "You are a helpful assistant...",
            tech_agent_sql_gen: "Generate PostgreSQL SQL... {catalog}",
            tech_agent_explain: "Explain the SQL results...",
            finance_agent: "Answer finance questions...",
            data_quality_checklist: "Note: data may have quality issues.",
            dashboard_designer: "Generate dashboard widgets.",
            self_query_transform: "Extract search filters... {query}",
            data_scientist_python_gen: "Write Python code... {tableName} {columns} {dateHint} {numericCols} {categoryCols} {schemaDef} {ragContext} {dataSource} {sampleJson} {statsSummary} {analysisType} {analysisHints} {chartType} {chartReason} {totalRows}",
            data_scientist_explain: "Explain Python results... {analysisType} {query} {pythonCode} {output}",
            tech_agent_python_gen: "Write Python code... {rawQuery}",
            tech_agent_python_explain: "Summarize Python results... {pythonCode} {output}",
            sql_retry_feedback: "SQL failed... {query} {feedback} {schemaContext}",
            empty_result_feedback: "SQL returned empty results.",
            data_profiler_passport: "Generate data passport... {tableName} {description} {columnInfo} {sampleRows} {sampleJson}",
            data_profiler_system: "Return only valid JSON.",
        }),
    },
}));
