...
const CHART_DESCRIPTIONS: Record<string, string> = {
  ...
  cashflow_summary: "Мөнгөн урсгалын бүх төрлийг (орлого, зарлага) сараар бүлэглэн харуулна. Аль төрлийн орлого зарлага аль сард их гарсан харна.",
  income_statement: "Орлого, зарлагыг дэд ангилал тус бүрээр хажуулан харьцуулна. Аль төрлийн орлого/зарлага хамгийн их хувь эзлэхийг харна.",
  expense_category_stats: "Зарлагын дэд ангилал бүрийг нийт дүн болон хувийн жингийн хамт харуулна. Аль ангилалд хэдэн төгрөг зарцуулсан, нийт зарлагад эзлэх хувийг харуулна.",
};
